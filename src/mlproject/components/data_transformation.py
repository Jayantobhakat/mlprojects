...
class DataTransformation:
        ...
        try:
            ...
            preprocessor=ColumnTransformer(
                [
                    ...
                    ("cut_pipeline",cat_pipeline,categorical_columns)
                ]
            )
            return preprocessor
    ...
    def initiate_data_tranformation(self,train_path,test_path):
        try:
            ...
            ## divide the dataset to independent and dependent features

            input_feature_train_df.drop(columns=[target_column_name],axis=1)
